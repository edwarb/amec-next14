        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl text-center">
            <h1 className="text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl">
              Kembali sehat dan percaya diri
            </h1>
            <p className="mt-6 text-lg leading-8 text-gray-600">
              Amalia Medical Center berkomitmen untuk menyediakan layanan kesehatan terbaik dengan penuh kasih sayang dan profesionalisme. Kesehatan Anda dan keluarga adalah prioritas utama kami.
            </p>
          </div>

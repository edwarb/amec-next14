    ...
    <div className="mx-auto max-w-7xl px-6 lg:px-8">
            ...
            <div className="sm:grid sm:grid-cols-2 md:gap-8">
              <div>
                ...
                <p className="text-sm leading-6 text-gray-600">
                  Graha Amalia<br />
                  Jl. Dewi Sartika 364 A Cawang, Jakarta Timur 13630
                </p>
              </div>
              <div>
      ...
      >
        <div className="text-center">
          <p className="text-sm leading-6 text-gray-600 flex items-center justify-center">
            &copy; 2024 Amalia Medical Center - Crafted with
